...
import { Battery, Zap, LogIn, Eye, EyeOff } from 'lucide-react';
    ...
    try {
      ...
      if (error) {
        if (error.message.includes('Invalid login credentials')) {
          setError('Invalid email or password. Please check your credentials and try again. If you haven\'t registered yet, please sign up first.');
        } else {
      ...
      <div className="max-w-md w-full space-y-8">
        <div className="text-center">
          ...
          <p className="mt-2 text-sm text-gray-600">
            Access your secure accounting dashboard
          </p>
        </div>
            ...
            <div>
              ...
              <div className="mt-1 relative">
                <input
                  ...
                  className="block w-full px-3 py-2 pr-10 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-green-500 focus:border-green-500"
